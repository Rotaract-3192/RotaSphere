    ...
    if (maplibregl && mapContainerRef.current && isOlaConfigured) {
      ...
      filteredEvents.forEach(evt => {
        if (evt.latitude && evt.longitude) {
          ...
          let markerColor = '#ff7759'; // Coral default
          if (evt.category === 'professional') markerColor = '#9b60aa'; // Violet
          if (evt.category === 'community') markerColor = '#10b981'; // Emerald
          if (evt.category === 'club') markerColor = '#3b82f6'; // Blue
