                      ...
                      <div className="grid grid-cols-1 md:grid-cols-5 gap-6 items-start">
                        <div className="md:col-span-3 space-y-4">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1.5">
                              <Label htmlFor="organizer" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Organizer Name *</Label>
                                      ...
                                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                        <div className="space-y-1">
                                          ...
                                          <Input 
                                            ...
                                            className="rounded-lg h-8 text-xs border-muted-foreground/15 font-semibold"
                                          />
                                        </div>
                                        <div className="space-y-1">
                        ...
                        <div className="md:col-span-3 space-y-4">
                          ...
                          <div className="space-y-3 bg-muted/15 rounded-xl p-4 border border-muted/50">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div>
                                <span className="text-[10px] uppercase font-bold text-muted-foreground">Organizer</span>
